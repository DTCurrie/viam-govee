...
var GoveeLightSensor = common.Family.WithModel("govee-light-sensor")
...
// SensorConfig is the configuration for the govee-light-sensor component.
...
func (s *goveeLightSensor) Readings(ctx context.Context, _ map[string]interface{}) (map[string]interface{}, error) {
	...
	if bri, ok := state.Brightness(); ok {
		readings["brightness"] = bri
	}
